...
BOT_TOKEN = environ.get('BOT_TOKEN', "7641758752:AAErirjisfFsRo9w-y2t19pElMvuRxXQ1GI")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7717701360').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002324232643').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001865863393')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002324232643')).split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://interworld:itzmecp@cluster0.jfui5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Interworld')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Itzmecp') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Interworld_Request')
CHNL_LNK = environ.get('CHNL_LNK', 't.me/interworldmx')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Interworld_Request') # Support Chat Link Without https:// or @
